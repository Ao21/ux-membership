...
gulp.task('inject:html', function() {
  ...
  return target
  		.pipe($.inject(series(vendorStream,appStream), { ignorePath:'build' ,relative: true,addRootSlash:false } ))
		.pipe($.inject(gulp.src(['!./build/libs/vendors/**/jquery**','!./build/libs/vendors/**/lodash**','./build/libs/vendors/**',]), {name: 'bower',relative:false, ignorePath: '/build/'}))
